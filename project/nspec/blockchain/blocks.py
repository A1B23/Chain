...
class blockchain:
    ...
    def verifyThenAddBlock(self, block):
        ...
        m_info['blocksCount'] = len(m_Blocks)
        m_info['cumulativeDifficulty'] = m_info['cumulativeDifficulty'] + 16 ^ block['difficulty']
    ...
    def verifyThenStoreBlock(self, block, mblocks, minfo, balList):
        ...
        minfo['cumulativeDifficulty'] = minfo['cumulativeDifficulty'] + 16 ^ block['difficulty']
        minfo['confirmedTransactions'] = m_info['confirmedTransactions'] + len(block['transactions'])
        return ""
