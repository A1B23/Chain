...
set nodeIPnum=52
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runWallet.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2 --port %port% --useDelay %delay%"
set nodeIPnum=54
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runWallet.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 4 --port %port% --useDelay %delay%"
...
set nodeIPnum=4
echo %typeDir% start at IP 127.0.0.%nodeIPnum%
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runBC.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2,5 --port %port% --minPeers %minPeers% --maxPeers %maxPeers% --useDelay %delay%"
...
set maxPeers=1
set nodeIPnum=32
rem start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runMiner.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2 --minPeers %minPeers% --maxPeers %maxPeers% --useDelay %delay%" -mod %mode%"
set nodeIPnum=34
...
set col=2B
echo %typeDir% start at IP 127.0.0.%nodeIPnum%
start cmd.exe /K "color %col% &title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runBC.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2 --port %port% --minPeers %minPeers% --maxPeers %maxPeers% --useDelay %delay%"
