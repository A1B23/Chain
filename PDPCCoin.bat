...
set nodeIPnum=52
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runWallet.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2 --port %port%"
set nodeIPnum=54
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runWallet.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 4 --port %port%"
...
rem start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runBC.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 4 --port %port% --minPeers %minPeers% --maxPeers %maxPeers%"

set nodeIPnum=4
echo %typeDir% start at IP 127.0.0.%nodeIPnum%
start cmd.exe /K "color %col% & title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runBC.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2,5 --port %port% --minPeers %minPeers% --maxPeers %maxPeers%"
...
set col=2B
echo %typeDir% start at IP 127.0.0.%nodeIPnum%
start cmd.exe /K "color %col% &title=%typeDir%-127.0.0.%nodeIPnum% & %myPyPath% runBC.py --host 127.0.0.%nodeIPnum% --netID %netID% --connect 2 --port %port% --minPeers %minPeers% --maxPeers %maxPeers%"
